...
button = ctk.CTkButton(app, text="Upload a resume", corner_radius=32, hover_color="#0b3459", fg_color="transparent", border_color="#028fc4", border_width=2, width=150, command=lambda: upload_file())
button.place(relx=0.5, rely=0.2, anchor="center")

textbox = ctk.CTkTextbox(app, width=200, height=100, corner_radius=10)
textbox.pack(padx=10)
textbox.place(relx=0.5, rely=0.5, anchor="center")

button = ctk.CTkButton(app, text="Submit", corner_radius=32, hover_color="#0b3459", fg_color="transparent", border_color="#028fc4", border_width=2, width=90, command=lambda: algorithm(textbox.get("0.0", "end"), '../hiring_service/'))
